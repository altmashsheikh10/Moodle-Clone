...
<html>
<head>
    <title><?php echo $_SESSION['course_2']; ?></title>
    <meta charset="utf-8">
...
?>
    <div class = "main"> 
        <div class="geek1" style="border:inset; border-color:gray; border-width: 10px;"><?php echo $_SESSION['course_2']; ?></div>
    </div> <br>
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12 well">
                    <a href="lab.php">LAB ASSIGNMENT-1 due 23/11/2021</a>
                </div>
            </div>
        </div>
        <div class="col-lg-6 well">
            ...
            <div class="row">
                <div class="col-lg-12 well ">
                    <p>The End-sem Exam will start from 2:00PM to 5:00PM.</p>
                </div>
            </div>
        </div>
    </div>
