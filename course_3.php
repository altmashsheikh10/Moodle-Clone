...
<html>
<head>
    <title><?php echo $_SESSION['course_3']; ?></title>
    <meta charset="utf-8">
...
?>
    <div class = "main">
        <div class="geek1" style="border:inset; border-color:gray; border-width: 10px;"><?php echo $_SESSION['course_3']; ?></div>
    </div> <br>
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12 well">
                    <a href="lab.php">LAB ASSIGNMENT-1 due 24/11/2021.</a>
                </div>
            </div>
        </div>
        <div class="col-lg-6 well">
